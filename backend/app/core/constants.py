...
class AuditAction(StrEnum):
    ...
    ENRICHMENT_UPLOADED = "ENRICHMENT_UPLOADED"
    ENRICHMENT_PROCESSED = "ENRICHMENT_PROCESSED"
    ENRICHMENT_REVIEWED = "ENRICHMENT_REVIEWED"
    ENRICHMENT_INTEGRATED = "ENRICHMENT_INTEGRATED"


class EnrichmentStage(StrEnum):
    """Processing stages for an "Upload & Enrich" run, surfaced verbatim in the UI stepper."""
...
class EnrichmentMappingStatus(StrEnum):
    ...
    APPROVED = "APPROVED"
    REJECTED = "REJECTED"
    APPROVED_WITH_OPEN_ISSUE = "APPROVED_WITH_OPEN_ISSUE"
    INTEGRATION_READY = "INTEGRATION_READY"


class EnrichmentIssueType(StrEnum):
    MISSING_METADATA = "MISSING_METADATA"
    MISSING_DESCRIPTION = "MISSING_DESCRIPTION"
    INCONSISTENT_METADATA = "INCONSISTENT_METADATA"
    AMBIGUOUS_MAPPING = "AMBIGUOUS_MAPPING"
    CONFLICTING_DEFINITION = "CONFLICTING_DEFINITION"
    DUPLICATE_GLOSSARY_TERM = "DUPLICATE_GLOSSARY_TERM"
    ...
    ORPHAN_SOURCE_SYSTEM = "ORPHAN_SOURCE_SYSTEM"
    UNMAPPED_DOCUMENTATION = "UNMAPPED_DOCUMENTATION"


class EnrichmentIssueSeverity(StrEnum):
    LOW = "LOW"
    MEDIUM = "MEDIUM"
    HIGH = "HIGH"


class EnrichmentIssueStatus(StrEnum):
    OPEN = "OPEN"
    RESOLVED = "RESOLVED"
